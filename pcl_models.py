...
def build_pcl_tables(metadata: MetaData) -> Dict[str, Table]:
    ...
    pacer_saved_searches = Table(
        ...
        Column("search_mode", String(20), nullable=False),
        Column("criteria_json", Text, nullable=False),
        Column("schedule", String(40), nullable=True),
        Column("active", Boolean, nullable=False, server_default=sa_text("true")),
        Column("created_by", String(120), nullable=True),
        ...
        CheckConstraint(
            "search_type in ('case','party')",
            name="ck_pacer_saved_searches_type",
        ),
        CheckConstraint(
            "search_mode in ('immediate','batch')",
            name="ck_pacer_saved_searches_mode",
        ),
    ...
    docket_document_items = Table(
        ...
        Column("text_status", Text, nullable=True),
        Column("text_path", Text, nullable=True),
        Column("text_engine", Text, nullable=True),
        Column("text_confidence", Float, nullable=True),
        Column("text_content", Text, nullable=True),
        Column("text_char_count", Integer, nullable=True),
        Column("text_word_count", Integer, nullable=True),
        Column("text_meta_json", Text, nullable=True),
        Column("text_extracted_at", DateTime(timezone=True), nullable=True),
